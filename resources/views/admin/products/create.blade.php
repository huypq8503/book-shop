                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade  border border-primary p-3 show active" id="home-tab-pane"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="small_description" class="form-control" id="" cols="30" rows="10"></textarea>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="tab-pane fade border p-3 " id="details-tab-pane" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="checkbox" name="trending" class="form-control form-check-input mt-0">
                                </div>
                                <div class="mb-3">
                                    <label for="">Featured</label>
                                    <input type="checkbox" name="featured" class="form-control form-check-input mt-0">
                                </div>
                                <div class="mb-3">
                                    <label for="">Status</label>
                                    <input type="checkbox" name="status" class="form-control form-check-input mt-0">
                                </div>
                            </div>
